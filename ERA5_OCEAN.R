...
write.csv2(resultados_ocean,"A:/ERA5_RESULTS/ocean_results_min.csv" )


resultados_ocean <- read.csv2("A:/ERA5_RESULTS/ocean_results_max.csv")
resultados_ocean2 <- read.csv2("A:/ERA5_RESULTS/ocean_results.csv")
...
for (i in 1:length(s)){
  ...
  writeRaster(r,paste0("A:/ERA5_RESULTS/RASTER/OCEAN/", s[i] ,"_min.tif" ))
  ...
  ggsave(paste0("A:/ERA5_RESULTS/PLOT/OCEAN/", s[i] ,"_min.jpeg" ), dpi = 600, width = 30, height = 30, units = "cm")
